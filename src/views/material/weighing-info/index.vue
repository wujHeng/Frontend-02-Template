  ...
  <div style="margin-top: 25px">
    ...
    <el-table :data="tableBinCbData" border style="width: 100%">
      <el-table-column label="炭黑称">
        <el-table-column prop="tank_name" label="炭黑罐"></el-table-column>
        <el-table-column prop="material_name" label="物料名称">
          <template slot-scope="scope" v-if="scope.row.used_flag">{{ scope.row.material_name }}</template>
        </el-table-column>
    ...
    <el-table :data="tableBinOilData" border style="width: 75%">
      <el-table-column label="油料称">
        <el-table-column prop="tank_name" label="油料罐"></el-table-column>
        <el-table-column prop="material_name" label="物料名称">
          <template slot-scope="scope" v-if="scope.row.used_flag">{{ scope.row.material_name }}</template>
        </el-table-column>
        <el-table-column prop="low_value" label="慢称值">
