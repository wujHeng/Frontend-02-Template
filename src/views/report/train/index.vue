<template>
  <div v-loading="loading" class="report-train-style">
    ...
    >
      ...
      <el-table-column prop="product_no" label="配方编号"></el-table-column>
      <el-table-column prop="plan_classes_uid" label="计划编号"></el-table-column>
      ...
      <el-table-column prop="plan_trains" label="设定车次"></el-table-column>
      <el-table-column prop="actual_trains" label="实际车次"></el-table-column>
      <el-table-column prop="production_details.控制方式" label="本/远控"></el-table-column>
      <el-table-column prop="production_details.作业方式" label="手/自动"></el-table-column>
      <el-table-column prop="production_details.总重量" label="总重量"></el-table-column>
      <el-table-column prop="production_details.排胶时间" label="排胶时间"></el-table-column>
      <el-table-column prop="production_details.排胶温度" label="排胶温度"></el-table-column>
      <el-table-column prop="production_details.排胶能量" label="排胶能量"></el-table-column>
      <el-table-column prop="production_details.员工代号" label="操作人"></el-table-column>
      <el-table-column prop="production_details.存盘时间" label="存盘时间" width="100"></el-table-column>
      <el-table-column prop="production_details.密炼时间" label="密炼时间"></el-table-column>
      <el-table-column prop="production_details.间隔时间" label="间隔时间"></el-table-column>
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button @click="clickView(scope.row,scope.row.id,scope.$index)" size="mini">查看</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <div style="overflow-x:scroll;margin-top:20px" v-if="showRowTable">
      <el-row style="min-width:1600px" v-loading="loaddingExal">
...
export default {
  ...
  methods: {
    ...
    getCurveInformation(id) {
      try {
        let data = curveInformation("get", { params: { id: id } });
        let test = [
          {
            id: 1,
            时间: "20",
