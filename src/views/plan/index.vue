<template>
  <div style="margin-top: 25px">
    ...
    <el-row>
      <el-form style="margin-left: 10px" :inline="true">
        <el-form-item label="机台">
          <el-select clearable @change="equipChange" v-model="equip" placeholder="请选择">
            <el-option
    ...
    >
      ...
      <el-table-column prop="stage_product_batch_no" label="配方名称"></el-table-column>
      <el-table-column prop="begin_time" label="开始时间"></el-table-column>
      <el-table-column prop="end_time" label="结束时间"></el-table-column>
      <el-table-column prop="equip_name" label="机台"></el-table-column>
      <el-table-column prop="classes" label="班次"></el-table-column>
      <el-table-column prop="plan_trains" label="设定"></el-table-column>
      <el-table-column prop="actual_trains" label="完成"></el-table-column>
      <el-table-column prop="operation_user" label="操作员"></el-table-column>
      ...
      <el-form :inline="true">
        ...
        <el-row>
          <el-form-item label="班次: ">
            <el-select clearable v-model="calss" placeholder="请选择">
              <el-option
        ...
        <el-row>
          <el-form-item label="配方: ">
            <el-select clearable v-model="recipe" placeholder="请选择">
              <el-option
...
export default {
  ...
  methods: {
    ...
    async getClassList() {
      try {
        let classData = await globalCodes("get", {
